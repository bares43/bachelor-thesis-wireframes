    ...
    $.fn.wireframe = function(options, fn) {
        ...
        function walk(node) {
            ...
            if(jq.is("script")){
                ...
                processFormSelect(jq);
                walkChilds = false;
            }
            else if(jq.is("textarea:isFormTextarea")){
                processFormTextarea(jq);
                walkChilds = false;
            }
        ...
        function processFormRadio(radio){
            var radioWf = $("<input />");
        ...
        function processFormCheckbox(checkbox){
        ...
        function processFormButton(button){
            var buttonWf = $("<input />");
        ...
        function processFormSelect(select){
            var selectWf = $("<select />");
        ...
        function processFormTextarea(textarea){
